...
const NewShoppingCart = () => {
  ...
  return (
    <div className="w-full min-h-screen pt-10 bg-[#F0F3F7]">
      <div>
        <div className="w-5/6 mb-5 px-5 rounded-t-xl mx-auto bg-[#B70000]">
          <p className="font-sans text-white">Your Cart</p>
        </div>
        ...
        <div className="flex justify-between items-center w-5/6 mx-auto bg-[#B70000] mt-5 p-5 rounded-b-xl ">
          ...
          <button className="text-white bg-[#8E0808] w-32">Finish</button>
        </div>
      </div>
    </div>
  );
