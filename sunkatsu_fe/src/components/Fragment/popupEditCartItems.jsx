...
const PopupEditCartItems = ({ show, onClose, cartItem }) => {
  ...
  if (!show) return null;
  return (
    <div className="flex justify-center items-center h-screen fixed inset-0 bg-gray-300 bg-opacity-20 z-50">
      <div className="relative flex  gap-5 w-7/12 rounded-2xl p-6 bg-white shadow-md">
...
export default PopupEditCartItems;
